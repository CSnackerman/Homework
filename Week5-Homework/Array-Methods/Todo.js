...
console.log('user3Todos', user3Todos);

const user3IncompleteTodos = user3Todos.filter((todo) => !todo.completed);
console.log('user3IncompleteTodos', user3IncompleteTodos);
...
uniqueUserIds.forEach((uid) => {
  const key = `user${uid}`;
  const userTodos = todos.filter((todo) => todo.userId === uid);
  const incompleteTasks = userTodos
